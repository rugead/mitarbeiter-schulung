        ...
        <div className="min-h-screen px-4 text-center">
            ...
            <div className="inline-block w-full max-w-md w-30 p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  ...
                  Bitte geben Sie jetzt Ihre vierstellige Personalnummer ein:
                  <InputField label="Personalnummer" type="text" placeholder="Personalnummer" name="personalnummer" onChange={onChangeHandler} />
                  </div>
                </div>
